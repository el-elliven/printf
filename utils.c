...
/**
 * append_the_hexa_code - Append ascci in hexadecimal code to buffer
...
/**
 * is_the_digit - Verifies if a char is a digit
 * @a: Char to be evaluated
 *
 * Return: 1 if a is a digit, 0 otherwise
 */
int is_the_digit(char a)
{
	if (a >= '0' && a <= '9')
		return (1);
